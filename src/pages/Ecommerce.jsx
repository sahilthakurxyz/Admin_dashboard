  ...
  return (
    <div className="mt-12">
      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        ...
        >
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className=" text-2xl">$961,454.</p>
            </div>
          </div>
          {/* download button */}
          <div className="mt-6">
        ...
        {/* customer section products sales refunds section */}
            ...
            <div className=" border-r-2 border-color m-4 pr-10">
              <div>
                <p>
                  ...
                  <span className=" p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 ml-2 ">
                    23%
                  </span>
                </p>
              ...
              <div className="mt-10">
                <div className=" dark:text-gray-400 hover: shadow-xl">
                  <Button
                    color="white"
                    bgColor={currentColor}
